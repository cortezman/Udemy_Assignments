...
namespace StocksUnitTest
{
    public class UnitTest1
    {
        ...
        public void GetAllBuyOrders_EmptyList()
        {
            ...
            List<BuyOrderResponse> buyOrdersList = _stocksService.GetBuyOrders();
            Assert.Empty(buyOrdersList);
        }

        [Fact]
        public void GetAllBuyOrders_WithBuyOrder()
        {
        ...
        [Fact]
        public void GetAllSellOrder_EmptyList()
        {

            List<SellOrderResponse> sellOrderList = _stocksService.GetSellOrders();
            Assert.Empty(sellOrderList);
        }

        [Fact]
        public void GetAllSellOrder_WithBuyOrder()
        {
            ...
            List<SellOrderResponse> sellOrdersList = _stocksService.GetSellOrders();
